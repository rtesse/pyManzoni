...
project = 'PyManzoni'
copyright = u'2021-2022, Robin Tesse (robin.tesse@ulb.be)'
author = u'Robin Tesse (robin.tesse@ulb.be)'
...
latex_documents = [
    (master_doc, 'Georges.tex', 'Georges Documentation',
...
man_pages = [
    (master_doc, 'georges', 'Georges Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Georges', 'Georges Documentation',
     author, 'Georges', 'One line description of project.',
     'Miscellaneous'),
]
